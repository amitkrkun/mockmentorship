  ...
  return (
    <div className='mb-10 items-center px-5 flex flex-col gap-2'>
        ...
        text-4xl tracking-wide'>
            Search <span className='text-primary'>Interviwers</span></h2>
        <h2 className='text-gray-500 text-xl'>Search Your Interview preparation guide and Book Appointment in one click</h2>
